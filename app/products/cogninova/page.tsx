        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-[#0D0C1A]">
          <div className="max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h3 className="text-2xl font-bold text-white mb-1">CogniNova Learning Hub</h3>
                <p className="text-[#B8B6C4] mb-6">AI-Powered Educational Platform that revolutionizes learning through intelligent coaching, knowledge graphs, and personalized educational experiences</p>
                <div className="space-y-4">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white">AI Coach Suite</h4>
                      <p className="text-[#B8B6C4]">Personalized AI tutors that adapt to each student&apos;s learning style, providing real-time guidance and enhancing critical thinking skills through interactive problem-solving.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white">Knowledge Graph-Based Learning</h4>
                      <p className="text-[#B8B6C4]">Dynamic curriculum mapping that connects concepts across subjects, creating personalized learning pathways based on syllabus requirements and individual progress.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="font-semibold text-white">Comprehensive School ERP</h4>
                      <p className="text-[#B8B6C4]">Integrated management system handling admissions, attendance, grades, scheduling, and communication - all powered by AI for maximum efficiency.</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gradient-to-br from-[#15151D] to-[#1E1B38] p-8 rounded-2xl border border-[#29263A] shadow-[0_10px_35px_rgba(0,0,0,0.4)]">
                <div className="text-center">
                  ...
                  <h4 className="text-xl font-bold text-white mb-4">CogniNova Learning Hub</h4>
                  <p className="text-[#B8B6C4]">Comprehensive educational ecosystem that combines AI coaching, knowledge graph-based curriculum, and intelligent assessment to create personalized learning journeys for every student.</p>
                </div>
              </div>
            </div>
          </div>
