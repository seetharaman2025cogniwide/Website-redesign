        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-sm text-[#B8B6C4]">Real-time insights</div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-[#1E1B38] rounded-lg p-4 text-center border border-[#8B5CF6]/30">
              <div className="text-2xl font-bold text-[#A78BFA]">2.4M</div>
              <div className="text-xs text-[#B8B6C4]">Data Points</div>
            </div>
            <div className="bg-[#1E1B38] rounded-lg p-4 text-center border border-emerald-500/30">
              ...
              <div className="text-xs text-[#B8B6C4]">Accuracy</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-[#1E1B38] rounded-lg border border-[#29263A]">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-white">Customer Behavior</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[#1E1B38] rounded-lg border border-[#29263A]">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-white">Revenue Analytics</span>
              </div>
              <span className="text-xs text-[#A78BFA] font-medium">Stable</span>
            </div>
          </div>
        </div>
      </div>
