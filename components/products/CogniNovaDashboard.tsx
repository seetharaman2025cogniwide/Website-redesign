        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <div className="font-semibold text-white">CogniNova Dashboard</div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="bg-[#1E1B38] rounded-lg p-4 text-center border border-[#8B5CF6]/30">
              <div className="text-2xl font-bold text-[#A78BFA]">156</div>
              <div className="text-xs text-[#B8B6C4]">Students</div>
            </div>
            <div className="bg-[#1E1B38] rounded-lg p-4 text-center border border-emerald-500/30">
              ...
              <div className="text-xs text-[#B8B6C4]">Engagement</div>
            </div>
            <div className="bg-[#1E1B38] rounded-lg p-4 text-center border border-amber-500/30">
              <div className="text-2xl font-bold text-amber-400">8.4</div>
              <div className="text-xs text-[#B8B6C4]">Avg Score</div>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <div className="flex items-center justify-between p-3 bg-[#1E1B38] rounded-lg border border-[#29263A]">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-sm font-medium text-white">AI Coach Session</span>
              </div>
            ...
            <div className="flex items-center justify-between p-3 bg-[#1E1B38] rounded-lg border border-[#29263A]">
              ...
              <span className="text-xs text-[#A78BFA] font-medium">Learning</span>
            </div>
          </div>
        </div>
      </div>
